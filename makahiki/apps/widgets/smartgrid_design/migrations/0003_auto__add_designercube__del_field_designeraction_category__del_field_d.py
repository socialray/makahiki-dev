...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DesignerAction.category'
        db.delete_column('smartgrid_design_designeraction', 'category_id')

        # Deleting field 'DesignerAction.level'
        db.delete_column('smartgrid_design_designeraction', 'level_id')

        # Deleting field 'DesignerAction.priority'
        db.delete_column('smartgrid_design_designeraction', 'priority')

        # Deleting field 'DesignerCategory.priority'
        db.delete_column('smartgrid_design_designercategory', 'priority')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'DesignerAction.category'
        db.add_column('smartgrid_design_designeraction', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartgrid_design.DesignerCategory'], null=True, blank=True), keep_default=False)

        # Adding field 'DesignerAction.level'
        db.add_column('smartgrid_design_designeraction', 'level', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartgrid_design.DesignerLevel'], null=True, blank=True), keep_default=False)

        # Adding field 'DesignerAction.priority'
        db.add_column('smartgrid_design_designeraction', 'priority', self.gf('django.db.models.fields.IntegerField')(default=1000), keep_default=False)

        # Adding field 'DesignerCategory.priority'
        db.add_column('smartgrid_design_designercategory', 'priority', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
    ...
    models = {
        ...
        'smartgrid_design.designercube': {
            'Meta': {'ordering': "('level', 'column', 'row')", 'object_name': 'DesignerCube'},
