...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'DesignerCategoryGrid'
        db.delete_table('smartgrid_design_designercategorygrid')

        # Adding model 'DesignerColumnName'
        db.create_table('smartgrid_design_designercolumnname', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, db_index=True)),
        ))
        db.send_create_signal('smartgrid_design', ['DesignerColumnName'])

        # Adding model 'DesignerColumnGrid'
        db.create_table('smartgrid_design_designercolumngrid', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('smartgrid_design', ['DesignerColumnGrid'])
    ...
    def backwards(self, orm):
        ...
        # Adding model 'DesignerCategoryGrid'
        db.create_table('smartgrid_design_designercategorygrid', (
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartgrid_design.DesignerCategory'])),
            ('column', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('level', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartgrid_design.DesignerLevel'])),
        ))
        db.send_create_signal('smartgrid_design', ['DesignerCategoryGrid'])

        # Deleting model 'DesignerColumnName'
        db.delete_table('smartgrid_design_designercolumnname')

        # Deleting model 'DesignerColumnGrid'
        db.delete_table('smartgrid_design_designercolumngrid')
    ...
    models = {
        ...
        'smartgrid_design.designercolumngrid': {
            'Meta': {'object_name': 'DesignerColumnGrid'},
