...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LibraryAction.type'
        db.add_column('smartgrid_library_libraryaction', 'type', self.gf('django.db.models.fields.CharField')(default=2, max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LibraryAction.type'
        db.delete_column('smartgrid_library_libraryaction', 'type')
